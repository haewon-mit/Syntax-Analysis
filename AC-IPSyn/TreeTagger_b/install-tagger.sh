...
then
    gzip -cd english-par-3.1.bin.gz > lib/english.par
...
then
    gzip -cd english-par-linux-3.1.bin.gz > lib/english.par
...
if [ -r spanish-par-linux-3.1.bin.gz ]
then
    gzip -cd spanish-par-linux-3.1.bin.gz > lib/spanish.par
